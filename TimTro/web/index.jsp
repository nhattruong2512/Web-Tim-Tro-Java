...
<html lang="en-US" prefix=""><!--<![endif]--><head>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 clearfix">
                                <div class="user_welcome">
                                    <a class="link user_register_link" href="dangbai.jsp" rel="nofollow"><i></i> Đăng bài</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="navbar_collapse_custom" id="bs-example-navbar-collapse-1">
                                    ...
                                    <div class="menu-main-menu-container">
                                        <ul class="container-menu" id="menu-main-menu">
                                            ...
                                            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-92649" id="menu-item-92649"><a ><span>Cho thuê phòng trọ</span></a></li>
